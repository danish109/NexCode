          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <motion.div variants={itemVariants}>
              ...
              <input
                ...
                } text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition`}
                {...register("firstName")}
              />
              {errors.firstName && (
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative">
                <input
                  ...
                  } text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition pr-12`}
                  {...register("password")}
                />
                <button
                  type="button"
            ...
            <motion.div variants={itemVariants} className="pt-2">
              <motion.button
                type="submit"
                className={`w-full bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold py-3 px-4 rounded-lg transition ${
